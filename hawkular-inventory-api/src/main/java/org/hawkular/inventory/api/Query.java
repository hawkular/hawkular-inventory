...
public final class Query {
    ...
    public boolean equals(Object o) {
        ...
        return Arrays.equals(this.getFragments(), that.getFragments()) &&
               this.getSubTrees().equals(that.getSubTrees());
    }

    @Override
    public int hashCode() {
        int fragments = this.fragments != null ? Arrays.hashCode(this.fragments) : 0;
        int subTrees = this.subTrees != null ? this.subTrees.hashCode() : 0;
        return 31 * (fragments + subTrees) ;
    }
