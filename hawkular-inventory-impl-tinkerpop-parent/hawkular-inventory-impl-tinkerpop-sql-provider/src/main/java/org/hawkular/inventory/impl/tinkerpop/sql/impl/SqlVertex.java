...
public final class SqlVertex extends SqlElement implements Vertex {
    ...
    @Override protected String getUniquePropertiesTableName() {
        return graph.getUniqueVertexPropertiesTableName();
    }
    ...
    public Iterable<Edge> getEdges(Direction direction, String... labels) {
        ...
        case BOTH:
            ...
            sql.append(
                " UNION ALL SELECT e.id, e.vertex_in, e.vertex_out, e.label FROM edges e, vertices v WHERE v.id = ?" +
                        " AND e.vertex_out = v.id ");
            break;
        }
