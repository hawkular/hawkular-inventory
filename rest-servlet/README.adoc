...
[source, shell]
----
curl -i http://localhost:8080/hawkular/inventory/rest-test/resources/x1422733176502 -H "Content-Type: application/json"
HTTP/1.1 200 OK
...
[source,shell]
----
curl -i http://localhost:8080/hawkular/inventory/rest-test/resources/x1422733176502/metrics -H "Content-Type: application/json"
HTTP/1.1 200 OK
Connection: keep-alive
X-Powered-By: Undertow/1
Server: WildFly/8
